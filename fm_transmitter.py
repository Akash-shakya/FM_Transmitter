...
class fm_transmitter(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        ##################################################
        self.vol = vol = 1
        self.samp_rate = samp_rate = 43000
        self.noise = noise = 0

        ##################################################
        # Blocks
        ##################################################
        self._vol_range = Range(1, 10, 100, 1, 200)
        ...
        self.osmosdr_sink_0.set_center_freq(87.2e6, 0)
        ...
        self._noise_range = Range(0, 1, 100, 0, 200)
        self._noise_win = RangeWidget(self._noise_range, self.set_noise, "'noise'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._noise_win)
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/akash/Downloads/tu-hi-din-tu-hi-meri-raat-ve-haniya-ringtone-tkkb.wav', True)
